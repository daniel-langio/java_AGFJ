...
- [CI workflows](ci-workflows.md) — show-off video generation, semver releases.

Root [README](../README.md) has the quick-start commands; these go deeper on each feature.
